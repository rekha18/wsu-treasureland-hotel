<%@ Page Title="" Language="C#" MasterPageFile="~/Clerk/Clerkreports.master" AutoEventWireup="true" CodeBehind="RestaurantCashSalesReport.aspx.cs" Inherits="TreasureLand.Clerk.WebForm9" %><%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:SqlDataSource ID="sdsCashSalesDay" runat="server" 
...
ORDER BY me.MenuItemName" onselecting="sdsCashSalesDay_Selecting">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsCashSalesDateRange" runat="server" 
    ConnectionString="<%$ ConnectionStrings:HotelDBM %>" SelectCommand="
SELECT rdb.ReservationDetailBillingID, rdb.BillingDescription, rdb.BillingAmount,
              rdb.BillingItemQty, rdb.Comments, rdb.TransEmployee, u.UserName,
              li.lineItemTransactionID, li.LineItemAmount, me.MenuItemName
...
ORDER BY me.MenuItemName">
    ...
    Text="Cash Sales Report"></asp:Label>
    ...
    <ajaxToolkit:CalendarExtender ID="txtBeginDate_CalendarExtender" 
    runat="server" Enabled="True" TargetControlID="txtBeginDate" 
        Format="d/MM/yyyy">
...
&nbsp;<asp:TextBox ID="txtEndDate" runat="server"></asp:TextBox>
    <ajaxToolkit:CalendarExtender ID="txtEndDate_CalendarExtender" 
    runat="server" Enabled="True" TargetControlID="txtEndDate" Format="d/MM/yyyy">
    </ajaxToolkit:CalendarExtender>
    ...
    <asp:CompareValidator ID="cvEndDate" runat="server" 
        ...
        Type="Date" ValidationGroup="vgDate" CultureInvariantValues="True" 
        Enabled="False">*</asp:CompareValidator>
    <br />
    <asp:Button ID="btnGetSales" runat="server" Text="Get Cash Sales" 
        ValidationGroup="vgDate" onclick="btnGetSales_Click" />
    <br />
    ...
    WaitMessageFont-Size="14pt" Visible="False">
        <LocalReport ReportPath="Clerk\Reports\TotalRestaurantSales.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="sdsCashSalesDay" 
