<%@ Page Title="" Language="C#" MasterPageFile="~/Maintenance/MaintenanceMasterPage.master" AutoEventWireup="true" CodeBehind="MaintenanceShortTermAsset.aspx.cs" Inherits="TreasureLand.Maintenance.MaintenanceShortTermAsset" %>
...
&nbsp;<asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" 
    ...
    <asp:LinqDataSource ID="LinqDataSource2" runat="server" 
        ...
        <WhereParameters>
            <asp:Parameter DefaultValue="2" Name="DepartmentID" Type="Int16" />
        </WhereParameters>
    </asp:LinqDataSource>
    <br />
    <br />
